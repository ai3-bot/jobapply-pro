                    ...
                    <div className="col-span-2 p-2">
                        ...
                        {formData.hospitalSelection === 'change' && (
                            <div className="mt-2 ml-4 space-y-1 text-xs">
                                ...
                                {formData.changeReason === 'during_year' && (
                                    <div className="ml-4 space-y-1">
                                        <div className="font-semibold">เนื่องจาก</div>
                                        <label className="flex items-start gap-2">
                                            <PDFCheckbox checked={formData.duringYearReason === 'address'} />
                                            <span>ย้ายที่อยู่</span>
                                        </label>
                                        <label className="flex items-start gap-2">
                                            <PDFCheckbox checked={formData.duringYearReason === 'workplace'} />
                                            <span>เปลี่ยนสถานที่ทำงาน</span>
                                        </label>
                                        <label className="flex items-start gap-2">
                                            <PDFCheckbox checked={formData.duringYearReason === 'other'} />
                                            <span>อื่นๆ (ระบุ)</span>
                                            <span className={`border-b border-dotted border-slate-400 flex-1 text-center px-2 pb-1 ml-1`} style={{ minHeight: '1.2em' }}>
                                                {formData.duringYearReasonDetail || '\u00A0'}
                                            </span>
                                        </label>
                                    </div>
                                )}
