    ...
    return (
        ...
        >
            ...
            <div className="mb-4 leading-[1.4] flex flex-col items-end">
                <div>เขียนที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 ${formData.writtenAt ? '' : 'pb-2'}`} style={{ verticalAlign: 'baseline' }}>{formData.writtenAt || ''}</span></div>
                <div>เมื่อวันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 ${formData.writtenDate ? '' : 'pb-2'}`} style={{ verticalAlign: 'baseline' }}>
