...
export default function NDADocument({ applicant, formData = {} }) {
    ...
    return (
        ...
        >
            ...
            {/* Clause 1.2 */}
            <div className="mb-3 leading-[1.4] text-justify pl-[5px]">
            ...
            {/* Clause 1.6 */}
            <div className="mb-4 leading-[1.4] text-justify pl-[5px]">
        ...
        >
            ...
            {/* Clause 11.2 */}
            <div className="mb-6 leading-[1.4] text-justify pl-[5px]">
