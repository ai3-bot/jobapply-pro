...
export default function NDADocument({ applicant, formData = {} }) {
    ...
    const registeredAddr = p.registered_address || {};
    const currentAddr = p.current_address || {};
    const isDifferentAddress = p.current_address_type !== 'same';
    ...
    return (
        ...
        >
            ...
            <div className="mb-4 text-justify leading-[1.4]">
                ...
                <p>
                    <span className="font-semibold">ที่อยู่ตามทะเบียนบ้าน:</span> อยู่บ้านเลขที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1 ${registeredAddr.number}`} style={{ verticalAlign: 'baseline', ...(!registeredAddr.number && { minHeight: '1.2em' }) }}>{registeredAddr.number || '\u00A0'}</span>หมู่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[50px] text-center px-2 pb-1 ${registeredAddr.moo}`} style={{ verticalAlign: 'baseline', ...(!registeredAddr.moo && { minHeight: '1.2em' }) }}>{registeredAddr.moo || '\u00A0'}</span>ซอย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 pb-1 ${registeredAddr.soi}`} style={{ verticalAlign: 'baseline', ...(!registeredAddr.soi && { minHeight: '1.2em' }) }}>{registeredAddr.soi || '\u00A0'}</span>ถนน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${registeredAddr.road}`} style={{ verticalAlign: 'baseline', ...(!registeredAddr.road && { minHeight: '1.2em' }) }}>{registeredAddr.road || '\u00A0'}</span>
                </p>
                <p>
                    ตำบล/แขวง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${registeredAddr.subdistrict}`} style={{ verticalAlign: 'baseline', ...(!registeredAddr.subdistrict && { minHeight: '1.2em' }) }}>{registeredAddr.subdistrict || '\u00A0'}</span>อำเภอ/เขต<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${registeredAddr.district}`} style={{ verticalAlign: 'baseline', ...(!registeredAddr.district && { minHeight: '1.2em' }) }}>{registeredAddr.district || '\u00A0'}</span>จังหวัด<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${registeredAddr.province}`} style={{ verticalAlign: 'baseline', ...(!registeredAddr.province && { minHeight: '1.2em' }) }}>{registeredAddr.province || '\u00A0'}</span>
                </p>
                <p>
                    รหัสไปรษณีย์<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1 ${registeredAddr.zipcode}`} style={{ verticalAlign: 'baseline', ...(!registeredAddr.zipcode && { minHeight: '1.2em' }) }}>{registeredAddr.zipcode || '\u00A0'}</span>เบอร์โทรศัพท์มือถือ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${p.mobile_phone}`} style={{ verticalAlign: 'baseline', ...(!p.mobile_phone && { minHeight: '1.2em' }) }}>{p.mobile_phone || '\u00A0'}</span>
                </p>
                {isDifferentAddress && (
                    <>
                        <p className="mt-2">
                            <span className="font-semibold">ที่อยู่ปัจจุบัน:</span> อยู่บ้านเลขที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1 ${currentAddr.number}`} style={{ verticalAlign: 'baseline', ...(!currentAddr.number && { minHeight: '1.2em' }) }}>{currentAddr.number || '\u00A0'}</span>หมู่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[50px] text-center px-2 pb-1 ${currentAddr.moo}`} style={{ verticalAlign: 'baseline', ...(!currentAddr.moo && { minHeight: '1.2em' }) }}>{currentAddr.moo || '\u00A0'}</span>ซอย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 pb-1 ${currentAddr.soi}`} style={{ verticalAlign: 'baseline', ...(!currentAddr.soi && { minHeight: '1.2em' }) }}>{currentAddr.soi || '\u00A0'}</span>ถนน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${currentAddr.road}`} style={{ verticalAlign: 'baseline', ...(!currentAddr.road && { minHeight: '1.2em' }) }}>{currentAddr.road || '\u00A0'}</span>
                        </p>
                        <p>
                        ...
                        <p>
                            รหัสไปรษณีย์<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1 ${currentAddr.zipcode}`} style={{ verticalAlign: 'baseline', ...(!currentAddr.zipcode && { minHeight: '1.2em' }) }}>{currentAddr.zipcode || '\u00A0'}</span>
                        </p>
                    </>
                )}
                <p className="mt-1">
