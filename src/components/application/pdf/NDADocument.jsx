            ...
            <div className="mb-8 leading-[1.4]">
                <div className="grid grid-cols-3 gap-8">
                    ...
                    <div className="col-span-2">
                        ...
                        <p className="mb-2">วันที่<span className="border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 pb-1 mx-2" style={{ verticalAlign: 'baseline', ...(!companyData.companySignDate && { minHeight: '1.2em' }) }}>{formatDateToDDMMYYYY(companyData.companySignDate) || '\u00A0'}</span></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mb-2">วันที่<span className="border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 pb-1 mx-2" style={{ verticalAlign: 'baseline', ...(!formData.employeeSignDate && { minHeight: '1.2em' }) }}>{formatDateToDDMMYYYY(formData.employeeSignDate) || '\u00A0'}</span></p>
                    </div>
                </div>
            </div>
