...
export default function EmploymentContractDocument({ applicant, formData = {} }) {
    ...
    return (
        ...
        >
            ...
            {/* Location and Date */}
            <div className="mb-4 leading-[1.4]">
                <p>ทำที่<span className="border-b border-dotted border-slate-400 inline-block min-w-[400px] text-center px-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span></p>
                <p>วันที่<span className="border-b border-dotted border-slate-400 inline-block min-w-[400px] text-center px-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span></p>
            </div>

            {/* Main Content */}
            <div className="mb-4 text-justify leading-[1.4] space-y-3">
                <p className="indent-8">
                    ข้าพเจ้า<span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 ${applicant?.full_name ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!applicant?.full_name && { minHeight: '1.2em' }) }}>{applicant?.full_name || ''}</span>บัตรประจำตัวประชาชนเลขที่
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 ${p.id_card ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!p.id_card && { minHeight: '1.2em' }) }}>{p.id_card || ''}</span>ออกให้โดย<span className="border-b border-dotted border-slate-400 inline-block min-w-[250px] text-center px-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>
                </p>

                <p>วันหมดอายุ<span className="border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>ขอมอบอำนาจให้บริษัท<span className="border-b border-dotted border-slate-400 inline-block min-w-[350px] text-center px-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span></p>
                ...
                <p className="indent-8">ให้หนังสือมอบอำนาจฉบับนี้มีผลเริ่มใช้บังคับตั้งแต่วันที่<span className="border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>เป็นต้นไป จนกว่าการดำเนินการกับเรื่องดังกล่าวข้างต้นในครั้งนี้จะเสร็จการ ซึ่งการใด ๆ ที่ผู้รับมอบอำนาจได้กระทำภายใต้เงื่อนไขหนังสือมอบอำนาจฉบับนี้ ให้มีผลผูกพันผู้มอบอำนาจ เสมือนหนึ่งว่าผู้มอบอำนาจ ได้กระทำการดังกล่าวด้วยตนเองทุกประการ เพื่อเป็นหลักฐาน แห่งการนี้ จึงได้ลงลายมือชื่อในหนังสือมอบอำนาจฉบับนี้ไว้ต่อหน้าพยานเป็นสำคัญ</p>
            </div>

            {/* Signatures */}
            <div className="mb-6 leading-[1.4] mt-12">
                <div className="grid grid-cols-2 gap-8 mb-8">
                    <div className="text-center">
                        <p>(ลงชื่อ)<span className="inline-block border-b border-dotted border-slate-400 w-[200px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '40px', display: 'inline-block' }}>&nbsp;</span>ผู้มอบอำนาจ</p>
                        <p className="mt-2">(<span className={`inline-block min-w-[200px] ${applicant?.full_name ? '' : 'border-b border-dotted border-slate-400'}`}>{applicant?.full_name || ''}</span>)</p>
                    </div>
                    <div className="text-center">
                        <p>(ลงชื่อ)<span className="inline-block border-b border-dotted border-slate-400 w-[200px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '40px', display: 'inline-block' }}>&nbsp;</span>ผู้รับมอบอำนาจ</p>
                        <p className="mt-2">(<span className="inline-block border-b border-dotted border-slate-400 w-[200px]">&nbsp;</span>)</p>
                    </div>
                </div>
            ...
            {/* Note */}
            <div className="mb-4 text-[11px] leading-[1.4]">
        ...
        {/* Page 11 - หนังสือยินยอมในการเข้าตรวจดูข้อมูลข่าวสารส่วนบุคคล */}
        <div 
            className="pdpa-page bg-white text-slate-900 mx-auto relative text-[12px] font-sans p-[20mm] shadow-sm print:shadow-none mt-8"
            style={{ 
                width: '210mm', 
        ...
        >
            ...
            <div className="mb-4 text-justify leading-[1.4] space-y-3">
                <p className="indent-8">
                    ข้าพเจ้า (นาย/นาง/น.ส.)<span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 ${applicant?.full_name ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!applicant?.full_name && { minHeight: '1.2em' }) }}>{applicant?.full_name || ''}</span>บัตรประจำตัวประชาชนเลขที่
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${p.id_card ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!p.id_card && { minHeight: '1.2em' }) }}>{p.id_card || ''}</span>อยู่บ้านเลขที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 ${(formData.houseNumber || currentAddr.number) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.houseNumber || currentAddr.number) && { minHeight: '1.2em' }) }}>{formData.houseNumber || currentAddr.number || ''}</span>หมู่ที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 ${(formData.moo || currentAddr.moo) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.moo || currentAddr.moo) && { minHeight: '1.2em' }) }}>{formData.moo || currentAddr.moo || ''}</span>ซอย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 ${(formData.soi || currentAddr.soi) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.soi || currentAddr.soi) && { minHeight: '1.2em' }) }}>{formData.soi || currentAddr.soi || ''}</span>ถนน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 ${(formData.road || currentAddr.road) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.road || currentAddr.road) && { minHeight: '1.2em' }) }}>{formData.road || currentAddr.road || ''}</span>
                </p>

                <p>ตำบล/แขวง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${(formData.subdistrict || currentAddr.subdistrict) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.subdistrict || currentAddr.subdistrict) && { minHeight: '1.2em' }) }}>{formData.subdistrict || currentAddr.subdistrict || ''}</span>อำเภอ/เขต<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${(formData.district || currentAddr.district) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.district || currentAddr.district) && { minHeight: '1.2em' }) }}>{formData.district || currentAddr.district || ''}</span>จังหวัด<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${(formData.province || currentAddr.province) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.province || currentAddr.province) && { minHeight: '1.2em' }) }}>{formData.province || currentAddr.province || ''}</span>โทรศัพท์<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 ${p.mobile_phone ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!p.mobile_phone && { minHeight: '1.2em' }) }}>{p.mobile_phone || ''}</span></p>

                <p className="font-bold">โดยหนังสือฉบับนี้</p>

                <p className="indent-8">1. ข้าพเจ้ายินยอมให้<span className="border-b border-dotted border-slate-400 inline-block min-w-[350px] text-center px-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>ซึ่งเป็นหน่วยงานของรัฐ หรือบริษัท สำนักงานตั้งอยู่ที่</p>
                
                <p><span className="border-b border-dotted border-slate-400 inline-block min-w-[600px] text-center px-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>ซึ่งเป็นหน่วยงาน ที่ข้าพเจ้าได้ขออนุญาต หรือสมัครงาน มีสิทธิ์ดำเนินการใด ๆ เข้าตรวจดูข้อมูล ข่าวสารส่วนบุคคล (ประวัติอาชญากรรม) ของข้าพเจ้าเพื่อวัตถุประสงค์<span className="border-b border-dotted border-slate-400 inline-block min-w-[350px] text-center px-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span></p>

                <p className="indent-8">2. ข้าพเจ้ายินยอมให้สำนักงานตำรวจแห่งชาติ หรือสำนักงานพิสูจน์หลักฐานตำรวจ หรือ กองทะเบียนประวัติอาชญากร หรือเจ้าหน้าที่ตรวจสอบประวัติ ดำเนินการจัดเก็บข้อมูล และลายพิมพ์นิ้วมือของข้าพเจ้า รวมทั้งเปิดเผยข้อมูลของข้าพเจ้าแก่หน่วยงานของรัฐเพื่อใช้ขออนุญาต หรือสมัครงานตามอำนาจหน้าที่ของหน่วยงานของรัฐนั้น หรือบริษัทที่ข้าพเจ้าใช้สมัครงาน และดำเนินการใด ๆ ที่เกี่ยวข้องได้ ข้าพเจ้าจะไม่เรียกร้อง ร้องเรียน หรือฟ้องร้องทั้งในความผิดทางแพ่ง ทางอาญา และทางปกครอง</p>
            ...
            <div className="mb-6 leading-[1.4] mt-8">
                <div className="text-center">
                    <p>(ลงชื่อ)<span className="inline-block border-b border-dotted border-slate-400 w-[250px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '40px', display: 'inline-block' }}>&nbsp;</span>ผู้ให้ความยินยอม</p>
                    <p className="mt-2">(<span className={`inline-block min-w-[250px] ${applicant?.full_name ? '' : 'border-b border-dotted border-slate-400'}`}>{applicant?.full_name || ''}</span>)</p>
                </div>
            </div>
