        ...
        >
            ...
            <div className="mb-4 leading-[1.4]">
                <p className="indent-8">
                    สัญญาฉบับนี้ทำขึ้นที่ บริษัท เค แอนด์ โอ ซิสเต็มส์ แอนด์ คอนซัลติ้ง จำกัด เมื่อวันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[250px] text-center px-2 ${formData.contractDate ? 'pb-1' : ''}`}>{formData.contractDate || ''}</span>
                </p>
            </div>
