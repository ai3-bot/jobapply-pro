        ...
        >
            ...
            <div className="mb-4 text-justify leading-[1.4]">
                <p className="indent-8">
                    ...
                    บ้านเลขที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 ${formData.houseNumber ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.houseNumber && { minHeight: '1.2em' }) }}>{formData.houseNumber || ''}</span>หมู่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[50px] text-center px-2 ${formData.moo ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.moo && { minHeight: '1.2em' }) }}>{formData.moo || ''}</span>ซอย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 ${formData.soi ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.soi && { minHeight: '1.2em' }) }}>{formData.soi || ''}</span>ถนน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${formData.road ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.road && { minHeight: '1.2em' }) }}>{formData.road || ''}</span>ตำบล/แขวง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${formData.subdistrict ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.subdistrict && { minHeight: '1.2em' }) }}>{formData.subdistrict || ''}</span>อำเภอ/เขต
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${formData.district ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.district && { minHeight: '1.2em' }) }}>{formData.district || ''}</span>จังหวัด<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${formData.province ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.province && { minHeight: '1.2em' }) }}>{formData.province || ''}</span>รหัสไปรษณีย์<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 ${formData.zipcode ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.zipcode && { minHeight: '1.2em' }) }}>{formData.zipcode || ''}</span>เบอร์โทรศัพท์มือถือ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${p.mobile_phone ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!p.mobile_phone && { minHeight: '1.2em' }) }}>{p.mobile_phone || ''}</span>ซึ่งต่อไปใน
