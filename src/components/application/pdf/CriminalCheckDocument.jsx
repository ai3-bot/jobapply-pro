    ...
    return (
        ...
        >
            ...
            <div className="space-y-2 text-justify">
                <p>
                    ข้าพเจ้า <span className="border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center">{applicant?.full_name || '\u00A0'}</span> บัตรประจำตัวประชาชนเลขที่ <span className="border-b border-dotted border-slate-400 inline-block min-w-[230px] text-center">{p.id_card || '\u00A0'}</span> ออกให้โดย <span className="border-b border-dotted border-slate-400 inline-block min-w-[320px] text-center">{formData.idIssuedBy || '\u00A0'}</span> 
                </p>
                <p>
                    วันหมดอายุ <span className="border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center">{formData.idExpiry || '\u00A0'}</span> ขอมอบอำนาจให้บริษัท <span className="border-b border-dotted border-slate-400 inline-block min-w-[400px] text-center">{companyData.companyName || formData.companyName || '\u00A0'}</span>
                </p>
                <p>
