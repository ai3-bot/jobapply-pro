                     ...
                     <div>
                        ...
                        <div className="border-[0.5px] border-slate-400 p-3 text-[11px] space-y-1.5">
                            <div className="flex gap-1 items-center flex-nowrap">
                                ...
                                <span className="border-b border-dotted border-slate-400 flex-1 min-w-0 px-1 relative bottom-[2px]">{st.can_work_overtime === 'no' ? st.can_work_overtime_reason : ''}</span>
                            </div>
