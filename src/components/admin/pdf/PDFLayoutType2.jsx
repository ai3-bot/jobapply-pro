...
export default function PDFLayoutType2({ applicant }) {
    ...
    const Field = ({ label, value, width = "auto", labelWidth="auto", className = "" }) => (
        <div className={`flex items-end text-[12px] leading-tight ${className}`} style={{ width: className ? 'auto' : width }}>
            ...
            <div className="flex-1 border-b-[1.5px] border-dotted border-slate-400 text-slate-900 px-2 pb-0.5 text-center truncate relative top-[-1px]">
                {value || "-"}
            </div>
        </div>
    );
            ...
            <div className="border border-slate-800 rounded-sm">
                ...
                <div className="p-3 border-b border-slate-800 bg-slate-50/50">
                    <div className="flex gap-4 items-end text-[12px] leading-tight">
                        ...
                        <div className="border-b-[1.5px] border-dotted border-slate-400 flex-1 px-2 pb-0.5 text-center font-medium relative top-[-1px] truncate">{p.position_1}</div>
                        <div className="font-bold whitespace-nowrap">2</div>
                        <div className="border-b-[1.5px] border-dotted border-slate-400 flex-1 px-2 pb-0.5 text-center font-medium relative top-[-1px] truncate">{p.position_2}</div>
                        <div className="font-bold whitespace-nowrap">อัตราเงินเดือนที่ต้องการ</div>
                        <div className="border-b-[1.5px] border-dotted border-slate-400 w-32 px-2 pb-0.5 text-center font-medium relative top-[-1px] truncate">{p.expected_salary}</div>
                    </div>
                </div>
