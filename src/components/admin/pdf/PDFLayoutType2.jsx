            ...
            <div className="flex justify-between items-start mb-4">
                ...
                <div className="border border-slate-800 p-2 w-[40mm] text-[11px] space-y-1">
                    <div className="relative pl-5 h-4 flex items-center">
                        ...
                        <span className="leading-none absolute bottom-2">Web HR</span>
                    </div>
                    <div className="relative pl-5 h-4 flex items-center">
                        <div className="absolute left-0 top-0.5 w-3 h-3 border border-slate-600 bg-white rounded-[1px]"></div>
                        <span className="leading-none absolute bottom-2">สปส.(เข้า)......</span>
                    </div>
                    <div className="relative pl-5 h-4 flex items-center">
                        <div className="absolute left-0 top-0.5 w-3 h-3 border border-slate-600 bg-white rounded-[1px]"></div>
                        <span className="leading-none absolute bottom-2">B-plus</span>
                    </div>
                    <div className="relative pl-5 h-4 flex items-center">
                        <div className="absolute left-0 top-0.5 w-3 h-3 border border-slate-600 bg-white rounded-[1px]"></div>
                        <span className="leading-none absolute bottom-2">สปส.(ออก)......</span>
                    </div>
                </div>
