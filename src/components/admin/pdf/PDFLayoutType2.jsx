                        ...
                        <table className="w-full border-collapse text-[11px]">
                            <thead>
                                <tr className="bg-slate-50 text-center">
                                    <th className="border-[0.5px 0.5px 0.5px 0.5px] border-slate-400 p-1 w-[15%]">ระดับ</th>
                                    <th className="border-[0 0.5px 0.5px 0.5px] border-slate-400 p-1 w-[30%]">ชื่อสถานศึกษา</th>
                                    <th className="border-[0 0.5px 0.5px 0.5px] border-slate-400 p-1 w-[25%]">สาขาวิชา</th>
                                    <th className="border-[0 0.5px 0.5px 0.5px] border-slate-400 p-1 w-[10%]">เริ่มปีพ.ศ.</th>
                                    <th className="border-[0 0.5px 0.5px 0.5px] border-slate-400 p-1 w-[10%]">สำเร็จปีพ.ศ.</th>
                                    <th className="border-[0 0.5px 0.5px 0.5px] border-slate-400 p-1 w-[10%]">เกรด<br/>เฉลี่ย</th>
                                </tr>
                            </thead>
                            <tbody>
                                {[
