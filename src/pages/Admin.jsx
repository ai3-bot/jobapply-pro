    ...
    const handleDownloadAll = async () => {
        ...
        try {
            ...
            const elementToPdfBlob = async (element) => {
                ...
                const imgWidth = canvas.width; // A4_WIDTH_PX * SCALE
                const imgHeight = canvas.height;
                
                // Page height in pixels (scaled)
                ...
                for (let page = 0; page < totalPages; page++) {
                    ...
                    // Calculate the Y position to start from
                                        ...
                                        <CardContent className="p-6">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <Badge variant={doc.status === 'approved' ? 'success' : doc.status === 'submitted' ? 'warning' : 'secondary'}>
